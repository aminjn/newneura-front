          ...
          <>
            ...
            >
              <div className="flex items-center gap-2 mb-3">
                ...
                <button className="w-8 h-8 rounded-[10px] border-none cursor-pointer bg-transparent text-[var(--aw-text-muted)]" onClick={() => setShowDrawer(false)}><i className="fa-solid fa-xmark" /></button>
              </div>
              ...
              {!drawerQA ? (
                ...
                return (
                  <div className="flex flex-col gap-3">
                    ...
                    <button className="w-full py-2 rounded-[10px] cursor-pointer text-[12px] bg-transparent" style={{ border: '1px solid var(--aw-border)', color: 'var(--aw-text-muted)', fontWeight: 600 }} onClick={() => setDrawerQA(null)}><i className="fa-solid fa-arrow-right ml-1" />بازگشت به اقدامات</button>
                  </div>
                );
              })()}
            </motion.div>
