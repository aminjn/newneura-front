...
export const INITIAL_PERSONNEL: Personnel[] = [
  { id: 'p1', name: 'محمد حسینی', role: 'مدیر فروش', status: 'online', bg: 'aw-bg-sky', init: 'م', lastMsg: 'قرارداد جدید بسته شد', lastTime: '۱۱:۰۰', unread: 1, voip: '۳۰۱', email: 'm.hosseini@neura.ir', phone: '۰۹۱۲۱۱۱۲۲۳۳', company: 'alpha', permissions: ['dashboard', 'crm', 'orders', 'tasks', 'marketing'] },
  { id: 'p2', name: 'زهرا نوری', role: 'حسابدار', status: 'online', bg: 'aw-bg-amber', init: 'ز', lastMsg: 'فاکتورها بررسی شد', lastTime: '۱۰:۴۵', unread: 0, voip: '۳۰۲', email: 'z.noori@neura.ir', phone: '۰۹۱۲۲۲۲۳۳۴۴', company: 'alpha', permissions: ['dashboard', 'finance', 'orders'] },
  { id: 'p3', name: 'امیر کاظمی', role: 'پشتیبان فنی', status: 'offline', bg: 'aw-bg-emerald', init: 'ا', lastMsg: 'تیکت شماره ۴۵ بسته شد', lastTime: 'دیروز', unread: 0, voip: '۳۰۳', email: 'a.kazemi@neura.ir', phone: '۰۹۱۲۳۳۳۴۴۵۵', company: 'beta', permissions: ['dashboard', 'agents', 'tasks'] },
  { id: 'p4', name: 'مریم فرهادی', role: 'منابع انسانی', status: 'offline', bg: 'aw-bg-rose', init: 'م', lastMsg: 'قرارداد جدید آماده امضاست', lastTime: 'دیروز', unread: 0, voip: '۳۰۴', email: 'm.farhadi@neura.ir', phone: '۰۹۱۲۴۴۴۵۵۶۶', company: 'gamma', permissions: ['dashboard', 'personnel', 'tasks'] },
];
...
export const NOTIFICATIONS: Notification[] = [
  { id: 'n1', title: 'کمپین جدید آماده بررسی', desc: 'عامل بازاریابی کمپین جدیدی ایجاد کرده است.', time: '۵ دقیقه پیش', icon: 'fa-solid fa-bullhorn', iconBg: 'aw-bg-blue', type: 'chat', target: 'marketing', cta: 'مشاهده چت', category: 'agents' },
  { id: 'n2', title: 'فاکتور معوق', desc: 'فاکتور فناوری آینده هنوز پرداخت نشده.', time: '۱ ساعت پیش', icon: 'fa-solid fa-file-invoice-dollar', iconBg: 'aw-bg-orange', type: 'finance', target: 'pending', cta: 'مشاهده مالی', category: 'finance' },
  { id: 'n3', title: 'سرنخ جدید در CRM', desc: 'صنایع نور به عنوان سرنخ جدید ثبت شده.', time: '۲ ساعت پیش', icon: 'fa-solid fa-user-plus', iconBg: 'aw-bg-green', type: 'crm', target: 'leads', cta: 'مشاهده CRM', category: 'crm' },
  { id: 'n4', title: 'گزارش ماهانه آماده است', desc: 'گزارش عملکرد عامل‌ها برای ماه جاری تولید شد.', time: '۳ ساعت پیش', icon: 'fa-solid fa-chart-bar', iconBg: 'aw-bg-purple', type: 'reports', target: 'agent', cta: 'مشاهده گزارش', category: 'system' },
  { id: 'n5', title: 'جلسه فردا ساعت ۱۰', desc: 'عامل منشی جلسه‌ای برای فردا تنظیم کرده.', time: 'دیروز', icon: 'fa-solid fa-calendar-check', iconBg: 'aw-bg-pink', type: 'chat', target: 'secretary', cta: 'مشاهده چت', category: 'agents' },
  { id: 'n6', title: 'عامل فروش معامله را بست', desc: 'علی رضایی معامله «پخش البرز» را نهایی کرد.', time: '۴ ساعت پیش', icon: 'fa-solid fa-cart-shopping', iconBg: 'aw-bg-green', type: 'chat', target: 'sales', cta: 'مشاهده چت', category: 'agents' },
  { id: 'n7', title: 'سفارش خرید ثبت شد', desc: 'عامل تدارکات سفارش تأمین مواد اولیه را ثبت کرد.', time: '۵ ساعت پیش', icon: 'fa-solid fa-boxes-stacked', iconBg: 'aw-bg-orange', type: 'chat', target: 'procurement', cta: 'مشاهده چت', category: 'agents' },
  { id: 'n8', title: 'درخواست مرخصی', desc: 'محمد حسینی برای پنجشنبه درخواست مرخصی ثبت کرد.', time: '۱ ساعت پیش', icon: 'fa-solid fa-user-clock', iconBg: 'aw-bg-sky', type: 'personnel', target: '', cta: 'بررسی درخواست', category: 'personnel' },
  { id: 'n9', title: 'گزارش حضور و غیاب', desc: 'گزارش هفتگی حضور کارکنان آماده شد.', time: 'دیروز', icon: 'fa-solid fa-user-check', iconBg: 'aw-bg-emerald', type: 'personnel', target: '', cta: 'مشاهده', category: 'personnel' },
  { id: 'n10', title: 'پرداخت دریافت شد', desc: 'مبلغ ۱۲۰٬۰۰۰٬۰۰۰ ریال از فناوری آینده واریز شد.', time: '۶ ساعت پیش', icon: 'fa-solid fa-money-bill-wave', iconBg: 'aw-bg-teal', type: 'finance', target: '', cta: 'مشاهده مالی', category: 'finance' },
  { id: 'n11', title: 'مشتری جدید فعال شد', desc: 'صنایع نور از سرنخ به مشتری فعال تبدیل شد.', time: '۲ روز پیش', icon: 'fa-solid fa-user-group', iconBg: 'aw-bg-green', type: 'crm', target: '', cta: 'مشاهده CRM', category: 'crm' },
  { id: 'n12', title: 'به‌روزرسانی سیستم', desc: 'نسخه جدید Neura با بهبود عملکرد منتشر شد.', time: '۲ روز پیش', icon: 'fa-solid fa-cloud-arrow-down', iconBg: 'aw-bg-indigo', type: 'system', target: '', cta: 'جزئیات', category: 'system' },
  { id: 'n13', title: 'پشتیبان‌گیری خودکار', desc: 'پشتیبان‌گیری از داده‌ها با موفقیت انجام شد.', time: '۳ روز پیش', icon: 'fa-solid fa-database', iconBg: 'aw-bg-purple', type: 'system', target: '', cta: 'جزئیات', category: 'system' },
];
