...
export function AppProvider({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    const t = setTimeout(() => {
      ...
      else if (loggedIn) { setBriefingSeen(false); setAppStage('app'); }
